    ...
    <section className="bg-black py-16 md:py-24 !w-full !h-[622px]">
      <div className="container mx-auto max-w-[1312px] px-4 md:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="flex flex-col bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-3xl p-8 md:p-12 !w-[587px] !h-[645px]">
          ...
          <div className="relative">
            <div className="relative aspect-[1.122] rounded-3xl overflow-hidden !bg-cover !bg-center !bg-cover !bg-center !bg-none !bg-cover !bg-center !bg-cover !bg-center !bg-cover !bg-center !bg-cover !bg-center !w-[831px] !h-full !bg-cover !bg-center !bg-[url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/0cdc52da-1c8b-467b-8c37-4a187c0cfb9d/visual-edit-uploads/1763951364770-jh93mq24cse.png)] !bg-cover !bg-center">
              <Image
